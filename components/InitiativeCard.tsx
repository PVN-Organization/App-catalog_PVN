        ...
        <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex flex-wrap gap-4 items-center">
                 ...
                 {initiative.file_urls && initiative.file_urls.length > 0 && (
                    <button onClick={(e) => { e.stopPropagation(); onDoubleClick(initiative); }} className="text-gray-600 hover:text-blue-600 font-semibold transition flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                        </svg>
                        Tệp ({initiative.file_urls.length})
                    </button>
                )}
            </div>
